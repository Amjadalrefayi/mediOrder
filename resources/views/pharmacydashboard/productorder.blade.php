            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                     ...
                     <div class="clearfix">
                        <div class="hint-text">Showing <b>{{$carts->count()}}</b> out of <b>5</b> entries</div>
                        @if ($carts->hasPages())
