...
<html lang="en">
  <head>
    ...
    <link href={{asset('https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900')}} rel="stylesheet">
		...
		<link rel="stylesheet" href={{ asset('admindash/css/style.css') }}>
  </head>
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<h1><a href="" class="logo">Project Name</a></h1>
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="#"><span class="fa fa-home mr-3"></span> Homepage</a>
          </li>
          <li>
              <a href={{route('ss')}}><span class="fa fa-user mr-3"></span> Dashboard</a>
          </li>
          <li>
    ...
    <script src= {{ asset('admindash/js/jquery.min.js') }}></script>
    <script src=  {{ asset('admindash/js/popper.js') }} ></script>
